...
static GString *symbol_bd_php_get_autocomp_from_cache(gchar *cache_str, gchar *cache_completion, const gchar *symbol_prefix)
{
  GString *result=NULL;
...
static gchar *symbol_bd_php_get_symbols_matches (Symbolizable *self, const gchar *symbol_prefix, gint flags)
{
  ...
  if (symbol_bd_php_has_cache(symbolbddet->cache_str, symbolbddet->cache_completion, symbolbddet->cache_flags, symbol_prefix, flags)){
    symbolbddet->completion_string = symbol_bd_php_get_autocomp_from_cache(symbolbddet->cache_str, symbolbddet->cache_completion, symbol_prefix);
  } else {
