...
void scintilla_php_set_lexer(GtkScintilla *scintilla)
{
  ...
  get_preferences_manager_style_settings(main_window.prefmg, "c_operator", NULL , NULL, &fore, &back, NULL, NULL);
