...
/* private */
void			 gtk_source_style_scheme_apply		(GtkSourceStyleScheme *scheme,
								 GtkWidget            *widget,
...
gboolean		 _gtk_source_style_scheme_get_current_line_color
								(GtkSourceStyleScheme *scheme,
								 GdkColor             *color);
void			set_scintilla_lexer_comment_style
								(GtkWidget *widget, 
								 GtkSourceStyleScheme *scheme, 
								 gint sci_style,
								 const gchar *font_name,
								 guint font_size);
void 			set_scintilla_lexer_default_style	
								(GtkWidget *widget, 
								 GtkSourceStyleScheme *scheme, 
								 gint sci_style,
								 const gchar *font_name,
								 guint font_size);
void			set_scintilla_lexer_keyword_style
								(GtkWidget *widget, 
								 GtkSourceStyleScheme *scheme, 
								 gint sci_style,
								 const gchar *font_name,
								 guint font_size);
void			set_scintilla_lexer_variable_style
								(GtkWidget *widget, 
								 GtkSourceStyleScheme *scheme, 
								 gint sci_style,
								 const gchar *font_name,
