...
static void main_window_state_changed(GtkWidget *widget, GdkEventWindowState *event, gpointer user_data)
{
    MainWindow *main_window = (MainWindow *) user_data;
    set_preferences_manager_window_maximized(main_window->prefmg, GDK_WINDOW_STATE_MAXIMIZED && event->new_window_state);
}

static void main_window_resize(GtkWidget *widget, GtkAllocation *allocation, gpointer user_data) 
{
    MainWindow *main_window = (MainWindow *) user_data;
...
static GtkWidget *get_widget_from_builder(MainWindow *main_window, const gchar *name){
...
static void side_panel_hide(MainWindow *main_window)
{
  gphpedit_debug(DEBUG_MAIN_WINDOW);
