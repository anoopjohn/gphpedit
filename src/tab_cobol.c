...
void scintilla_cobol_set_lexer(GtkScintilla *scintilla)
{
  ...
  if(get_preferences_manager_higthlight_caret_line (main_window.prefmg))
    gtk_scintilla_style_set_back (GTK_SCINTILLA(scintilla), STYLE_BRACELIGHT, get_preferences_manager_higthlight_caret_line_color(main_window.prefmg));
  else
  ...
  if(get_preferences_manager_higthlight_caret_line (main_window.prefmg))
    gtk_scintilla_style_set_back (GTK_SCINTILLA(scintilla), STYLE_BRACEBAD, get_preferences_manager_higthlight_caret_line_color(main_window.prefmg));
  else
